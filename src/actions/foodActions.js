...
import {FETCH_RECIPE_POSTERS,FETCH_RECIPE_MAKES} from "./types";
import axios from "axios";

//여기 설정하는게 2번째 순서
import {FETCH_RECIPE_LIST,FETCH_RECIPE_DETAIL,FETCH_RECIPE_COUNT,FETCH_RECIPE_PAGE} from "./types";
...
export const fetchRecipePoster=(no)=>dispatch=>{
...
export const fetchRecipeMake=(no)=>dispatch=>{
...
export const fetchFoodList=(page)=>dispatch=>{
    axios.get('http://localhost/food/list_react_redux',{
        params:{
            page:page
        }
        //                               foodReducer
...
export const fetchFindList=(fd)=>dispatch=>{
